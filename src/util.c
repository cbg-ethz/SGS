...
double score_node_1( unsigned int* data, int ncols_data, int nrows_data, unsigned int* node_sizes, unsigned int ni, unsigned int* pars, int length_pars, int func, double ess )
{
  ...
  switch (func)
  {
    case 0 : score = bdeu_score( (unsigned int *) data, ncols_data, nrows_data, node_sizes,
                                 ni, (unsigned int *) pars, length_pars, ess );
             break;
                
    case 1 : score = log_likelihood( (unsigned int *) data, ncols_data, nrows_data, node_sizes,
                                     ni, (unsigned int *) pars, length_pars, 0.5*log(nrows_data) );
             break;
    
    case 2 : score = log_likelihood( (unsigned int *) data, ncols_data, nrows_data, node_sizes,
