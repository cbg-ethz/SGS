...
#' bn <- BN(dataset)
#' ie <- InferenceEngine(bn)
#' ie <- loopy_belief.propagation(ie)
#' 
#' observations(ie) <- list("observed.vars"=("A","G","X"), "observed.vals"=c(1,2,1))
#' loopy_belief.propagation(ie)
#' }
#' 
#' @exportMethod loopy_belief.propagation
setGeneric("loopy_belief.propagation", function(ie, observations = NULL,
                                          return.potentials = FALSE) { standardGeneric("loopy_belief.propagation") } )
...
#' bn <- BN(dataset)
#' ie <- InferenceEngine(bn)
#' ie <- sub_belief.propagation(ie)
#' 
#' observations(ie) <- list("observed.vars"=("A","G","X"), "observed.vals"=c(1,2,1))
#' sub_belief.propagation(ie)
#' }
#' 
#' @exportMethod sub_belief.propagation
setGeneric("sub_belief.propagation", function(ie, observations = NULL,
                                                return.potentials = FALSE) { standardGeneric("sub_belief.propagation") } )
